...
const signup = async (body, res) => {
  ...
  await sendWelcomeEmail({ email: newUser.email, name: newUser.name }).catch(() => {});
...
// ─── resetPassword ────────────────────────────────────────────────────────────
const resetPassword = async ({ token, password, passwordConfirm }, res, next) => {
...
// ─── updatePassword ───────────────────────────────────────────────────────────
const updatePassword = async ({ currentUser, passwordCurrent, password, passwordConfirm }, res, next) => {
