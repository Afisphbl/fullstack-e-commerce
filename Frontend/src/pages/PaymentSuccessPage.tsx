...
const PaymentSuccessPage = () => {
  ...
  useEffect(() => {
    // Only verify once when orderId is available and we are in loading state
          ...
          {isPending && (
            <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
              <p className="text-sm text-yellow-900 dark:text-yellow-100">
                <strong>Please wait:</strong> Your payment is being verified.
                This usually takes a few minutes. You can check your order
          ...
          {isFailed && (
            <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
              <p className="text-sm text-red-900 dark:text-red-100">
                ...
                processed. Your order has been created but not paid. You can try
                paying again from your order details page.
              </p>
            </div>
          )}
            ...
            {isFailed ? (
              <>
                <Button asChild variant="default" className="flex-1">
                  <Link to={`/orders/${orderId}`}>Retry Payment</Link>
                </Button>
