          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <h1 className="mb-4 text-4xl font-display font-bold md:text-5xl">
                About <span className="text-gradient">VoltEdge</span>
              </h1>
              <p className="text-lg text-primary-foreground/75">
                We're on a mission to make cutting-edge technology accessible to
                everyone. Founded in 2020, VoltEdge has grown from a small
                startup to a global electronics destination trusted by millions.
              </p>
            </div>
