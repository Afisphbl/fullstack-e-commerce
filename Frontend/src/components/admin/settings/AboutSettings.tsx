...
import { SiteSettings, AboutStat, AboutValue } from "@/contexts/SiteSettingsContext";
...
export const AboutSettings = ({ draft, update }: AboutSettingsProps) => {
  const [aboutImagePreview, setAboutImagePreview] = useState<string>(draft.aboutImage);
